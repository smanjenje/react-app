...
function Sidebar() {
  ...
  return (
    <nav
      id="page-sidebar"
      className={`fixed top-0 left-0 bottom-0 z-50 flex flex-col w-64 border-gray-200 bg-white dark:bg-gray-900 ${
        stateMenu.mobileSidebarOpen ? "translate-x-0" : "translate-x-full"
